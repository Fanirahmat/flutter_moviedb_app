...
import 'package:flutter_moviedb_app/bloc/get_movies_bloc.dart';
...
class TopMoviesAdapter extends StatefulWidget {
  @override
  _TopMoviesAdapterState createState() => _TopMoviesAdapterState();
}

class _TopMoviesAdapterState extends State<TopMoviesAdapter> {
  @override
  void initState() {
    super.initState();
    movieBloc..getMovie();
